...
try {
    $stmt = $pdo->prepare("
        SELECT DISTINCT s.id, s.nome, s.codigo, t.titulo, 
        ...
        WHERE s.ativo = 1
        GROUP BY s.id, s.nome, s.codigo, t.titulo, s.lider_id
    ...
    echo json_encode(['success' => false, 'error' => 'Erro ao carregar salas']);
}
?>